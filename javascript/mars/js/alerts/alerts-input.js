...
class MarsInputAlert extends MarsUi {
    ...
    * @param {string} input The input element for which the message is shown
    ...
    */
     ...
     * @param {string} alert The alert to show
     * @protected
     */
    show (alert) {
        alert.hidden = false;
     ...
     * Hides an alert
     * @protected
     * @param {string} alert The alert to hide
     */
    hide (alert) {
        alert = mars.get(alert, true);
...
class MarsInputNotifications extends MarsInputAlert {
    class = 'alert-input alert-input-notification';
}
...
mars.define('inputNotifications', () => new MarsInputNotifications);