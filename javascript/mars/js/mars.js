...
class Mars {
    ...
    */
     ...
     * @param {string} [id] The id of the newly inserted HTML element to retrieve. If specified, that element will be returned
     * @param {string|object} [parent] The parent element to append to. If not specified, document.body is used
