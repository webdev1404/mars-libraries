...
class MarsLoading extends MarsUi {
    ...
    */
    ...
    /**
     * Shows the loading icon for a submit button
     * @param {string|object} element The submit button element
     * @return {this}
     */
    showForSubmit (element) {
        element = mars.get(element, true);

        element.classList.add(this.classes.submit);

        return this;
    }

    /**
     * Hides the loading icon for a submit button
     * @param {string|object} element The submit button element
     * @return {this}
     */
    hideForSubmit (element) {
        element = mars.get(element, true);

        element.classList.remove(this.classes.submit);
